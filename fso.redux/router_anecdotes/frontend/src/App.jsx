...
const Footer = () => (
  <div>
    Anecdote app for <a href='#'>Full Stack Open</a>.

    See <a href='#'>https://sus</a> for the source code.
  </div>
)
...
const CreateNew = ({addNew, setnotification}) => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/')
    setnotification('create success')
    setTimeout(()=>{
      setnotification('')
    },5000)
  }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type = "button" onClick={haneleReset}>reset</button>
      </form>
...
const Anecdote = ({anecdote}) =>{
  return(
    <div>
      <p>Content: <strong> {anecdote.content}</strong> - Author: {anecdote.author}</p>
